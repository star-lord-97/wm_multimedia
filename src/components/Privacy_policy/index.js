                ...
                <div id="wrapper">
                    <div className="container">
                        ...
                        <div className="privacy">
                            <strong>
                                The personal data that is going to be collected by Safebox service:
                            </strong>
                            <ol>
                                <li>1. IP address</li>
                                ...
                                <li>3. Cookies</li>
                                <li>
                                    4. Login, e-mail address, phone and any other data that may be
                            ...
                            <ol>
                                ...
                                <li>
                                    3. Providing an access to private part associated with specific
                                    user
                                </li>
                            ...
                            <p>
                                We require a prior user's consent before starting any data
                                processing on <strong>Safebox</strong>.
                            </p>
                            ...
                            <p>
                                We store the personal data until a deletion request from user or a
                                deletion on behalf of site's administrator.
                            </p>
                        </div>
                    </div>
                </div>

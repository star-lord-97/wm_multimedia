                        ...
                        <div className="container">
                                ...
                                <div className="headerbottom">
                                    <div className="logo wow fadeInUp">
                                        <img
                                            ...
                                            alt="Safebox page to upload photos and files"
                                        />
                                    </div>
                            ...
                            <a className="uploadarae wow fadeInUp" href="#">
                                <div className="uploadicons">
                                    <img
                                        src="vendor/images/upload_img1.png"
                                        alt="Safebox page to upload photos and files"
                                    />
                    ...
                    <div className="container">
                        ...
                        <ul>
                            ...
                            <li className="wow fadeInUp">
                                ...
                                <p>
                                    You can upload torrent files, which is a way of downloading a
                        ...
                        <div className="row">
                            <div className="col-xs-12 col-sm-12 col-md-7 col-lg-7">
                                <div className="txt wow fadeInUp">
                                    ...
                                    <p>
                                        Always interested in the smallest details, and that is for
                                        his desire to provide the best possible service, the site
                                        contains many services and features, but no matter how many
                                        services and features remain inadequate and become
                                        meaningless if the site is not available on the two most
                                        important elements as well as safety and speed as each of
                                        them has an important aspect and therefore it can better
                                        Highest possible and effective protection methods. The best
                                        electronic developments across the World Wide Web, the best
                                        possible speed. All of that, to get the dear member
                                        (visitor) the best experience of uploading, sharing and
                                        copying your files over the internet with ease and ease.{" "}
                                    </p>
                                </div>
                            </div>
                            <div className="col-xs-12 col-sm-12 col-md-5 col-lg-5">
                                <div className="img wow fadeInUp">
                                    <img
                                        src="vendor/images/img1.png"
                                        alt="Safebox page to upload photos and files"
                                    />
                                </div>
                            </div>

        ...
        return (
            <footer>
				<div className="container">
					...
					<div className="copyrights wow fadeInUp">All rights reserved to <a href="#" title="AHMED">Safebox Team</a> © 2020</div>
	
					<div className="mngez wow fadeInUp">
						<a href="#" rel="nofollow">Designed By : <img src="./vendor/images/water.png" alt="image footer"/>Safebox Team Designer</a>
					</div>
					<div className="clearfix"></div>
				</div>
	        </footer> 
